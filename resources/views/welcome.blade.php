...
@php
    ...
    $services = $services ?? [
        ['title' => 'Téléconsultation', 'description' => 'Consultez un médecin à distance en vidéo sécurisée.', 'icon' => 'fa-video', 'color' => 'primary'],
        ['title' => 'Rendez-vous', 'description' => 'Prenez un rendez-vous en cabinet ou en visio.', 'icon' => 'fa-calendar-check', 'color' => 'success'],
        ['title' => 'Pharmacie', 'description' => 'Faites préparer et livrer vos médicaments.', 'icon' => 'fa-pills', 'color' => 'warning'],
    ];

    $featuredDoctors = $featuredDoctors ?? collect();
    $testimonials = $testimonials ?? collect();
    $articles = $articles ?? collect();
    $partners = $partners ?? [
        ['name' => 'Partenaire 1', 'logo' => 'partner1.png'],
        ['name' => 'Partenaire 2', 'logo' => 'partner2.png'],
    ];
@endphp
            ...
            <div class="row g-3 align-items-center">
                <div class="col-md-3">
                    <select name="speciality" class="form-select form-select-lg">
                        ...
                        <option value="4">Gynécologue</option>
                        <option value="5">Pédiatre</option>
                    </select>
                </div>
                <div class="col-md-3">
