...
class MedicalStructureUpdateRequest extends FormRequest
{
    public function authorize(): bool
    {
        return $this->user()?->can('structures.update') ?? false;
    }
    ...
    public function rules(): array
    {
        return [
            'code_structure' => [
                ...
                'string',
                'max:50',
                Rule::unique('structures_medicales', 'code_structure')->ignore($this->route('structure'))
            ],
